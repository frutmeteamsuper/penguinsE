                                                      ...
                                                      <tr>
                                                         <td align="center" style="padding:20px 20px 10px 20px">
                                                            <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                               <tbody>
                                                                  <tr>
                                                                        <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 25px; line-height: 24px; text-align: left;" class="title-color">Hola ${newValidationAppToUser.adminName}, Hemos registrado una nueva solicitud de confirmación</h3>

                                                                        <p style="margin: 20px 20px 20px 20px;font-size: 25px;text-align: left;"> <b>Nro. de Reserva:</b> ${newValidationAppToUser.nroReserva}</p>
